...
4. All accounts (including the management account) must have Enterprise or Business Support enabled.
...
![](readme-images/add-email-for-account-dynamodb.png?raw=1)
